...
import { residentialRouter } from "./routers/residential";
import { entertainmentRouter } from "./routers/entertainment";
import { jobRouter } from "./routers/job";
import { advancedFacilitiesRouter } from "./routers/advancedFacilities";
import { professionRouter } from "./routers/profession";
...
export const appRouter = router({
  ...
  job: jobRouter,
  advancedFacilities: advancedFacilitiesRouter,
...
// Re-export job router for direct access
export { jobRouter };
