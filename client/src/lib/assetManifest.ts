...
export type AssetManifestEntry = {
  ...
  displayName: string;
  glbUrl: string | null;
  /** Procedural preview only; never promotes the asset to runtime-ready. */
  baselineGlbUrl?: string | null;
...
export const CORE_ASSET_MANIFEST: AssetManifestEntry[] = [
  {
    ...
    displayName: "玩家角色",
    glbUrl: null,
    baselineGlbUrl: "/manus-storage/player-character-baseline_b26d1cda.glb",
  ...
  },
  {
    id: "npc-quest-guild",
    kind: "npc",
    displayName: "任务大厅荣光使者",
    glbUrl: null,
    baselineGlbUrl: "/manus-storage/npc-citizen-baseline_6f36bf7e.glb",
    status: "pending-import",
  ...
  {
    id: "landmark-city-core",
    kind: "building",
    displayName: "城市核心",
    glbUrl: null,
    baselineGlbUrl: "/manus-storage/landmark-city-core-baseline_e168862c.glb",
    status: "pending-import",
  ...
  },
  {
    ...
    glbUrl: null,
    baselineGlbUrl: "/manus-storage/landmark-bank-baseline_04f6197a.glb",
    status: "pending-import",
    polygonBudget: { min: 5_000, max: 15_000 },
    textureResolution: "2K-4K",
    pbrRequired: true,
  ...
  },
  {
    ...
    displayName: "冰晶商业中心",
    glbUrl: null,
    baselineGlbUrl: "/manus-storage/landmark-commercial-baseline_28ee7e9c.glb",
    status: "pending-import",
    polygonBudget: { min: 5_000, max: 15_000 },
    textureResolution: "2K-4K",
    pbrRequired: true,
  ...
  {
    id: "landmark-production",
    kind: "building",
    displayName: "霜线生产区",
    glbUrl: null,
    baselineGlbUrl: "/manus-storage/landmark-production-baseline_821c3b99.glb",
    status: "pending-import",
    polygonBudget: { min: 5_000, max: 15_000 },
    textureResolution: "2K-4K",
    pbrRequired: true,
  ...
  },
  {
    ...
    displayName: "道路与路灯组件",
    glbUrl: null,
    baselineGlbUrl: "/manus-storage/environment-road-baseline_e861b9c3.glb",
    status: "pending-import",
  ...
  },
  {
    ...
    displayName: "植被与水渠组件",
    glbUrl: null,
    baselineGlbUrl: "/manus-storage/environment-vegetation-baseline_4d40d3ad.glb",
    status: "pending-import",
    polygonBudget: { min: 500, max: 10_000 },
    textureResolution: "2K",
    pbrRequired: true,
