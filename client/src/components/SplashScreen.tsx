...
export const SplashScreen: React.FC<SplashScreenProps> = ({ onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-gradient-to-b from-slate-950 to-slate-900">
      {/* Background image */}
      <div
        className="absolute inset-0 opacity-40"
        style={{
          backgroundImage: 'url(https://d2xsxph8kpxj0f.cloudfront.net/310519663391784042/Qmt32Hr7NUwpPACTV447zQ/splash_opening-R8fCMaXXq9SjWHre2EuwNR.webp)',
