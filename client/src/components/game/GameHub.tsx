...
const AgriculturalMapViewer = lazy(() => import("@/game/components/AgriculturalMapViewer"));

function MapContent() {
  return (
    <Suspense fallback={<div data-testid="game-content-loading" className="grid min-h-[22rem] place-items-center text-cyan-200">正在加载城市地图…</div>}>
      <AgriculturalMapViewer embedded />
    </Suspense>
  );
}
